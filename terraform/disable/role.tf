...
resource "aws_iam_role" "ecs_task_execution_role" {
  name               = "ecs_task_role-${var.application_key}-${var.application_stage}"
...
resource "aws_iam_role" "lambda_role" {
  name = "lambda_role-${var.application_key}-${var.application_stage}"
...
resource "aws_iam_role" "codedeploy_role" {
  name = "codedeploy_role-${var.application_key}-${var.application_stage}"
...
resource "aws_iam_role" "autoscale_role" {
  name = "autoscale-role-${var.application_key}-${var.application_stage}"
...
resource "aws_iam_role" "user_pool_sns_role" {
  name = "user_pool_sns_role-${var.application_key}-${var.application_stage}"
...
resource "aws_iam_policy" "user_pool_sns_role_policy" {
  name        = "user_pool_sns_role_policy-${var.application_key}-${var.application_stage}"
